        ...
        progress: [
            {
                ...
                milestone: "转向基于DDS+微波源混频的EOM移频方案",
            },
            {
        ...
        timeline: [
            {
                timestamp: "24-04-19",
                thisweek: [
                    "康威科技AD9910+STM32开发板到货",
                    "完成基于Keil5的STM32外部触发及AD9910同步调制功能，确认AD9910调制性能，测试拍频展宽",
                    "讨论当前实验内容中的沟通问题，整理汇总文档",
                ],
                nextweek: [
                    "NKT激光器测试",
                    "DDS+微波源混频测试",
            ...
            },
            {
                ...
                thisweek: [
                    "NKT激光器到货验货",
                    "讨论AD9910的使用细节，购买康威科技AD9910+STM32开发板",
                    "整理星地TF-QKD汇总文档",
                ],
                nextweek: [
                    "NKT激光器测试",
