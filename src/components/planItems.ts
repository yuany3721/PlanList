...
const planItems:OptionItem[] = [
        {
            ...
            timeline: [
                ...
                {
                    timestamp: "23-08-18",
                    thisweek: ["在500m链路中使用160kHz重频100ns脉宽完成采数",],
                    nextweek: ["数据分析"],
                },
                {
                    timestamp: "23-08-11",
            ...
            timeline: [
                {
                    ...
                    thisweek: [
                        "RIO激光器跑通上位机指令",
                        "使用高精度数据进行线性插值评估调制深度对调制效果的影响，线性插值1秒间隔频率偏差100kHz量级",
                ...
                },
                {
                    ...
                    thisweek: [
                        "VCO采购",
                        "测试电源和万用表精度，±2e-6V精度可以满足需求，调制深度不够",
                        "示波器DFT采数评估算法讨论，能够满足使用需求",
                        "线性插值评估调制深度对调制效果的影响"
                    ],
                    nextweek: [
                        "完善仿真需求，内部讨论",
                ...
                },
                {
                    ...
                    thisweek: [
                        "开展示波器采集、微波源连续调制测试",
                        "调研VCO方案",
                        "要到SMA100B的SMAB-K724是软件激活30天临时license"，
                        "整理仿真需求和接口文档",
                    ],
                    nextweek: [
                        "完善仿真需求，内部讨论",
